...
# Natural distribution shift variants of ImageNet. Unlike ImageNet-C these are not parameterised by severity.
# ImageNet-A and ImageNet-R cover a 200-class subset of ImageNet-1K; the class index lists below select the relevant
# logits from the model's 1000-dim output. ImageNet-V2 covers the full 1000 classes and requires no masking.
# Sources: https://github.com/hendrycks/natural-adv-examples (A), 
#          https://github.com/hendrycks/imagenet-r           (R),
#          https://github.com/modestyachts/ImageNetV2        (V2, matched-frequency variant)
IMAGENET_NATURAL_VARIANTS = ["imagenet-a", "imagenet-r", "imagenet-v2"]
...
# Class masks for 200-class variants only. ImageNet-V2 uses the full 1000-class label space and needs no masking.
...
METHODS = ["adabn", "basic", "cmf", "deyo", "eta", "eta_no_reset", "lame", "neo", "predbn", "sar", "shot", "shot_norm", "spa", "tent", "zerosiam"]
